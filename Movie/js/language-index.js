...
switcher.addEventListener('click', function(){
    ...
    if(switcher.checked){
        ...
        actorsh3index2.innerText = 'გამოიცანი მსახიობი';
        gift.placeholder = 'შეიყვანეთ მსახიობის სრული სახელი';
        gift1.placeholder = 'შეიყვანეთ მსახიობის სრული სახელი';
        gift2.placeholder = 'შეიყვანეთ მსახიობის სრული სახელი';
        gift3.placeholder = 'შეიყვანეთ მსახიობის სრული სახელი';
        gift4.placeholder = 'შეიყვანეთ მსახიობის სრული სახელი';
        gamocnobabutton1.innerText = 'გამოცნობა';
        gamocnobabutton2.innerText = 'გამოცნობა';
        gamocnobabutton3.innerText = 'გამოცნობა';
        gamocnobabutton4.innerText = 'გამოცნობა';
        gamocnobabutton5.innerText = 'გამოცნობა';
    }
})
